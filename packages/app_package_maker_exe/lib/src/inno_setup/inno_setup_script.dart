...
Name: "addstartup"; Description: "{cm:AutoStartProgram,{{DISPLAY_NAME}}}"; GroupDescription: "{cm:AdditionalIcons}"; Flags: {% if ADD_START_UP != true %}unchecked{% else %}checkedonce{% endif %}
[Files]
...
Name: "{userstartup}\\{{APP_NAME}}"; Filename: "{app}\\{{EXECUTABLE_NAME}}"; WorkingDir: "{app}"; Tasks: addstartup
[Run]
...
class InnoSetupScript {
  ...
  Future<File> createFile() async {
    Map<String, dynamic> variables = {
      ...
      'ADD_START_UP': makeConfig.addStartUp,
      'INSTALL_DIR_NAME':
